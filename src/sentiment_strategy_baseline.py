...
PROJECT = {"analysis_type": "sentiment_strategy", "category": "Market Signals & Event Analytics", "columns": ["date", "symbol", "headline", "summary", "next_day_return"], "methods": ["감성 label을 long/short/flat 포지션으로 변환하고 다음날 수익률에 적용한다.", "포지션 변경 시 거래비용을 차감해 look-good bias를 줄인다.", "뉴스 문장과 수익률은 신호 생성과 성과 연결을 설명하는 합성 데이터다."], "module_name": "sentiment_strategy_baseline", "objective": "뉴스 감성 신호를 다음 거래일 포지션으로 연결하고 비용 차감 성과를 계산한다.", "question": "단순 감성 신호가 비용을 차감한 뒤에도 방향성 전략으로 의미 있는가?", "rows": [["2026-03-04", "AAA", "AAA beats revenue expectations", "strong demand and margin improvement", 0.012], ["2026-03-05", "AAA", "AAA warns of delivery delay", "temporary disruption creates downside risk", -0.009], ["2026-03-06", "BBB", "BBB secures refinancing at lower spread", "funding improvement supports cash flow", 0.007], ["2026-03-07", "BBB", "BBB faces regulatory probe", "uncertainty and legal cost pressure shares", -0.014], ["2026-03-08", "CCC", "CCC launches buyback plan", "capital return improves shareholder outlook", 0.01]], "sample_name": "news_signal_returns.csv", "title_en": "Sentiment Trading Strategy", "title_ko": "감성 트레이딩 전략", "transaction_cost": 0.001}
